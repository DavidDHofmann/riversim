...
algorithm was originally developed by a [reddit user](https://www.reddit.com/r/proceduralgeneration/comments/ftgbgo/ive_been_working_on_an_algorithm_to_efficiently/).

## Installation
To install `riversim` you need to have the package `devtools` installed. You
can simply do:
